...
This is the code for the Route Planning project in my Udacity C++ Nanodegree. Instructions for each exercise can be found in the `instructions` directory, and unit tests for some exercises in the `test` directory.

## Cloning

When cloning this project, be sure to use the `--recurse-submodules` flag. Using HTTPS:
```
git clone https://github.com/nancyreschka/Route-Planning-Project --recurse-submodules
```
or with SSH:
```
git clone git@github.com:nancyreschka/Route-Planning-Project --recurse-submodules
```
